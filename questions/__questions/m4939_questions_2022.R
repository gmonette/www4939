...
#'    measured only once.
#' 
##+ 9 # Questions on data frames and data manipulation in R ----
...
#'        instead of others?
#'             
##+ 10 # Questions on graphics in R ----
#' # Questions on graphics in R
#'             
##+ 11 # Questions on functions in R ----
...
#'    are unchanged.
#'     
##+ 12 # Questions on OOP in R ----
#' # Questions on OOP in R
#' 
##+ 13 # Questions on Regression ----
