...
#' [these instructions](software_installation.html)
...
#' 
#' <!--
#' TODO: This is an example of a hidden comment that 
...
#' [R Markdown code](files/rmarkdown-2.0.pdf)
...
#' uniformity when collaborating it is suggested that you use 
#' ".R scripts with R Markdown" in this course.
#' 
...
#' the subject of this [xkcd](https://xkcd.com/) 
