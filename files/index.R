...
#' </pre>
#' @. __Additional optional software:__ To create Sweave and knitr LaTeX documents (more
#'    sophisticated alternatives to R Markdown) in RStudio, and to compile R
#'    Markdown documents directly to PDF files, download and install MiKTeX
#'    LaTeX software (for Windows) or the MacTeX LaTeX system (for macOS).
...
#'       - Run it as a Rmarkdown file by hitting: Ctrl-Shift-K. This should show you
#'         the ouput of the script in an HTML window.
